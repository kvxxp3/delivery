...
let AuthPage = class AuthPage {
  constructor(authService, router, loadingCtrl, alertController) {
  ...
  ngOnInit() {
    ...
    return (0,_home_karla_Documentos_booking_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormGroup({
        userId: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(_this.userAux.userId, {
          updateOn: 'blur'
        }),
        type: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(_this.userAux.type, {
          updateOn: 'blur'
        }),
        ...
        psw: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__.FormControl(null, {
          updateOn: 'blur',
          validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required]
        })
      });
        ...
        var _ref = (0,_home_karla_Documentos_booking_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (loadingEl) {
          ...
          if (_this3.isLogged) {
            ...
            if (data == true) {
              ...
              _this3.authService.updateUserType(_this3.userAux.type); //IF el tipo usuario es R da de alta direccion
...
AuthPage = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
  selector: 'app-auth',
